...
# without rustup (Homebrew, distro packages) ignores that file entirely — point
# LLVM_COV / LLVM_PROFDATA at your own copies of those two binaries there.
