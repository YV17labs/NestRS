...
Macro crate for the NestRS framework — the surface-agnostic decorators (#[injectable], #[module], #[hooks]). Re-exported by `nest-rs-core`: depend on that crate, not this one.
