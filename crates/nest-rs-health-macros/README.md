# nest-rs-health-macros

Macro crate for the NestRS framework — the #[indicators] decorator macro; re-exported by nest-rs-health: depend on that crate, not this one.
