...
use super::super::service::{AppOAuthService, Caller};

pub type AppOAuthGuard = nest_rs::authn::AuthnGuard<AppOAuthStrategy>;
...
#[injectable]
pub struct AppOAuthStrategy {
    #[inject]
    svc: Arc<AppOAuthService>,
}

#[async_trait]
impl Strategy for AppOAuthStrategy {
