...
use features::app_oauth::{AppOAuthService, AuthenticatedClient, IssuerConfig};
...
fn oauth_service() -> AppOAuthService {
    let jwt_svc = Arc::new(
    ...
    AppOAuthService::new(jwt_svc, providers, users_svc, config)
}
