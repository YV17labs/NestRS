...
[`orgs/`](https://github.com/YV17labs/NestRS/tree/main/demo/crates/features/src/orgs)
or [`users/`](https://github.com/YV17labs/NestRS/tree/main/demo/crates/features/src/users)
and import the matching `Authz<Transport>Module`. Before inventing a second
layout, open
...
Planned generators (see [Roadmap](https://github.com/YV17labs/NestRS/blob/main/ROADMAP.md)):
