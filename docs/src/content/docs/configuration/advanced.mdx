...
```rust title="crates/features/src/oauth/config.rs (from the demo, abridged)"
...
```rust title="crates/features/src/oauth/module.rs (from the demo)"
...
```rust title="crates/features/src/oauth/service.rs (from the demo)"
#[injectable]
...
```rust title="apps/auth/src/config.rs"
