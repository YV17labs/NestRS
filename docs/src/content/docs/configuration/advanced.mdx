...
```rust title="crates/features/src/app_oauth/config.rs (abridged)"
...
```rust title="crates/features/src/app_oauth/module.rs"
...
```rust title="crates/features/src/app_oauth/service.rs"
#[injectable]
