...
The login flow's provider endpoints, read by `OAuthClientConfig` in
...
`OAuthResourceModule` is what turns the app into a conformant OAuth 2.1
...
These read their own `NESTRS_<NAMESPACE>__*` keys. The rule is uniform: the
...
|---|---|
| `graphql` | [GraphQL configuration](/graphql/configuration/) |
| `openapi` | [OpenAPI](/openapi/) |
| `health` | [Health](/health/) |
| `throttler` | [Rate limiting](/rate-limiting/) |
| `ws` | [WebSockets](/websockets/) |
| `issuer` | the demo feature library — [the Publish workspace](/publish/) |
