...
let db_config = SeaOrmDatabaseConfig::from_env(&env, SeaOrmDatabaseConfig::defaults())?;
...
A seeded config wins over `ConfigModule::for_feature::<SeaOrmDatabaseConfig>()`,
