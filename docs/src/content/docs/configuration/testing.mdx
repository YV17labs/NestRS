...
```rust title="apps/publish-auth/tests/e2e.rs"
use nest_rs_testing::TestApp;
use uuid::Uuid;

#[tokio::test]
async fn issues_a_token_for_a_registered_client() {
    let app = TestApp::<PublishAuthModule>::builder()
...
```rust title="apps/publish-api/tests/e2e.rs"
use nest_rs_http::{HttpConfig, HttpModule};

let app = TestApp::<PublishApiModule>::builder()
    // ...
    .build()
    .await?;
```
