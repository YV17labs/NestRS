...
- [Responses](/http/responses/) — `Json<T>`, status + body tuples, and
  how several shapers compose.
- [Extractors](/http/extractors/) — the full extractor surface a handler
  parameter can take.
- [Errors](/http/errors/) — `ResponseError` on a feature error enum, and
  RFC 9457 problem responses.
- [Security](/security/) — binding a guard so the handler runs with a
  principal and an ambient ability.
