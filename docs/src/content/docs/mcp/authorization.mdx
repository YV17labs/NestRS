...
```text frame="terminal"
DEBUG mcp.operation{otel.kind="server" trace_id=01a014b2de3577c0bec25a6150d6627f span_id=3150b8f17af68017 parent_span_id=f4db23f0fd4e6060 actor_id="00000000-0000-7000-8000-00000000ac00"}: nest_rs::orm: listing rows entity="user"
```
