...
…
 ...
 INFO scheduled job{otel.kind="internal" trace_id=01a014a7409a7d60b6db79d6fb668cfe span_id=858be0eeb84fe593 provider="AudioTasks" method="warmup_on_boot"}: features::audio: audio pipeline ready to enqueue phase="warmup"
DEBUG scheduled job{otel.kind="internal" trace_id=01a014ad48107b2189deec939630eb9e span_id=5859a403369ada9f provider="AudioTasks" method="enqueue_transcode"}: features::audio: enqueued transcode job file="track-1717405126521.mp3"
 INFO scheduled job{otel.kind="internal" trace_id=01a014ada9b87c81a3ac2d6376f7cc06 span_id=c97ff4bd2ac5f292 provider="AudioTasks" method="heartbeat"}: features::audio: audio producer heartbeat queue="audio"
```
