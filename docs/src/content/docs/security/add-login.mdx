...
```rust title="crates/features/src/oauth/http/controller.rs (you write this)"
#[post("/login")]
...
pub type AuthnStrategy = nest_rs::authn::JwtStrategy<Claims>;

pub type AuthnGuard = nest_rs::authn::AuthnGuard<AuthnStrategy>;
```

```rust title="crates/features/src/authz/guard.rs"
...
#[module(imports = [UsersModule, AuthzModule], providers = [UsersController])]
