...
```text frame="terminal"
WARN http.request{trace_id=01a014ad539f7903986200f145f71c41 span_id=d7c5e5890c5a90eb http.request.method=GET url.path="/posts"}: nest_rs::authn: authentication failed reason="missing_credentials"
WARN http.request{trace_id=01a014ad539f7903986200f145f71c41 span_id=d7c5e5890c5a90eb …}: nest_rs::layers: guard denied the request status=401
```
...
[Persist through Postgres](/tutorial/database/) plugs `DatabaseModule` in, and
