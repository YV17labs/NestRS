...
```rust title="crates/features/src/posts/service.rs (from the demo)"
...
```rust title="crates/features/src/posts/module.rs (from the demo)"
...
```rust title="crates/features/src/authz/ability.rs (from the demo)" {2, 8}
...
```rust title="crates/features/src/posts/http/mod.rs (from the demo)"
mod controller;
mod module;
...
```rust title="crates/features/src/posts/mod.rs (from the demo)"
mod entity;
mod module;
mod service;
...
```toml title="apps/blog/Cargo.toml (from the demo)" {3}
[dependencies]
