...
description: A single tests/e2e.rs boots the real BlogModule against a throwaway database; nestrs run test e2e runs it; happy path and failure modes both asserted.
sidebar:
  order: 9
---
