...
and broadcasts the derived event. `apps/publish-live/src/chat/service.rs`
shows exactly this:
...
- [`apps/publish-live/src/chat/service.rs`](https://github.com/NestRS/NestRS/blob/main/apps/publish-live/src/chat/service.rs) —
