...
and broadcasts the derived event. `apps/chat/src/chat/service.rs`
shows exactly this:
...
- [`apps/chat/src/chat/service.rs`](https://github.com/NestRS/NestRS/blob/main/apps/chat/src/chat/service.rs) —
